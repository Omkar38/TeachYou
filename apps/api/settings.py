...
class Settings(BaseSettings):
    ...
    pixabay_api_key: str = Field(default="", validation_alias=AliasChoices("PIXABAY_API_KEY"))
    broll_results_per_scene: int = Field(default=5, validation_alias=AliasChoices("BROLL_RESULTS_PER_SCENE"))
